...
# ╔═╡ 3863146b-d39f-44da-a367-333e83fb5d22
using OrdinaryDiffEq, Sundials, DiffEqDevTools, Plots, ODEInterfaceDiffEq, ODE, LSODA

# ╔═╡ ccef0815-217e-456a-b8d1-1d3fa4e56417
using Random

# ╔═╡ cf9e1280-cbbe-11eb-0708-13adc54dbbee
pwd()

# ╔═╡ a089438c-63c9-4e3d-91e1-ea50b2fb3773
Random.seed!(123)

# ╔═╡ 28a75a0e-9b1d-4e4a-8674-1222dbd62de2
gr()

# ╔═╡ 927885f2-efa7-4497-93ae-c8da51ea243a
# 2D Linear ODE
...
# ╔═╡ e2fc7d75-1dc6-4636-8c55-739a21a340cf
function f_analytic(u₀,p,t)
  u₀*exp(1.01*t)
end

# ╔═╡ 1b14e7b5-d3e3-48c7-932e-8f3152ad6e72
tspan = (0.0,10.0)

# ╔═╡ 8a467544-0933-4933-9010-f9c4b4346173
prob = ODEProblem(ODEFunction(fn,analytic=f_analytic),rand(100,100),tspan)

# ╔═╡ 1296960d-09d9-4125-ae46-b930e9d2ff24
abstols = 1.0 ./ 10.0 .^ (3:13)

# ╔═╡ 4934cc4a-fc7a-40e9-a0f2-dac4a8e90de6
reltols = 1.0 ./ 10.0 .^ (0:10);

# ╔═╡ 2f2df91b-56c8-4080-b7ed-c6276de59f15
