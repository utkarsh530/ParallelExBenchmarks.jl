...
# ╔═╡ cf1460ff-8ed2-40a1-8c44-23e6dd6995a6
...
# ╔═╡ 402266f2-6723-4de5-9d0f-846a92c02262
...
# ╔═╡ 05a1e480-b0c6-4956-9d5e-9e0629b59e01
wp1 = WorkPrecisionSet(prob,abstols,reltols,setups1;error_estimator=:l2,
		save_everystep=false,appxsol=TestSolution(sol),maxiters=Int(1e5),numruns=10)

# ╔═╡ 95183831-ca2d-4dc3-b9cd-77edbc034422
plot(wp1)
...
labstols = 1.0 ./ 10.0 .^ (7:12)

# ╔═╡ 16331d5a-02d7-4b55-95ef-2a4a7223af19
lreltols = 1.0 ./ 10.0 .^ (4:9)
...
wp2 = WorkPrecisionSet(prob,abstols,reltols,setups3;
                      save_everystep=false,appxsol=TestSolution(sol),maxiters=Int(1e5),numruns=10)
