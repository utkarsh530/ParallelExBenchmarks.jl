...
setups = [
          ...
          Dict(:alg=>lsoda()),
          Dict(:alg=>radau()),
          Dict(:alg=>ImplicitEulerExtrapolation(min_order = 5, init_order = 3)),
          Dict(:alg=>ImplicitEulerBarycentricExtrapolation(min_order = 5)),
          Dict(:alg=>ImplicitHairerWannerExtrapolation()),
          ]

# solnames = ["CVODE_BDF", "KenCarp4", "Rodas4", "lsoda", "radau",""]
...
plt_ylims = (plt_ylims[1],plt_ylims[2]*4.8)
plot(wp,titlefontsize = 20, title = "Implicit Methods: POLLU",legendfontsize = 15,ylims = plt_ylims, legend = :topright, linewidth = 6, xticks = 10.0 .^ (-14.5:1:5),
